...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ELEV8 Developments — Living, Elevated" },
      { property: "og:description", content: "A Lebanese luxury real estate brand built on restraint, privacy, and clear architectural thinking." },
